    ...
    <div className="pb-24 bg-grey-50 min-h-screen">
      ...
      <div className="px-4 -mt-5 relative z-20 space-y-4 max-w-4xl mx-auto">
        ...
        <div className="pt-2">
          ...
          {isCurfewActive() ? (
            <div className="bg-gradient-to-br from-red-50 to-rose-100/60 rounded-3xl p-6 text-center border border-red-200 mt-2">
              ...
              <p className="text-xs text-red-800 font-medium leading-relaxed max-w-md mx-auto">
                Les courses sont automatiquement suspendues durant la nuit pour protéger les livreurs et les colis.
              </p>
            </div>
          ) : (
            <>
